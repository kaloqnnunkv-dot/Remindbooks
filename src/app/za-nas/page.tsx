...
export const metadata: Metadata = {
  title: "За нас",
  description:
    "Историята, мисията и ценностите на ReMindBooks — издателството за книги, които връщат посоката.",
...
const DEFAULTS: Record<string, string> = {
  ...
  about_intro:
    "ReMindBooks започна с едно просто убеждение: правилната книга, срещната в правилния момент, може да върне посоката на цял един живот.",
...
<p>Така се роди ReMindBooks — място, където подбираме и издаваме заглавия за хора, търсещи своя вътрешен компас. Не обещаваме бързи решения. Обещаваме честни книги, написани от хора, минали по пътя.</p>
<p>Днес освен хартиени издания предлагаме дигитални книги и аудио практики, защото знаем, че понякога посоката се намира в колата, на разходка или в тихите пет минути преди сън.</p>`,
  ...
  about_values_3_text:
    "Отговаряме на всяко съобщение лично. Зад ReMindBooks стоят хора, не автоматични отговори.",
  about_image: "",
};
