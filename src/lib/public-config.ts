...
export const publicConfig = {
  ...
  upload: {
    ...
    /**
     * Таван при качване направо в хранилището (аудио и видео).
     *
     * Там сървърът не е тясното място — файлът изобщо не минава през него.
     * 2 GB не е техническа граница (един PUT към R2 поема до 5 GB), а спирачка
     * срещу сбъркан файл: аудиокнига от 20 часа се побира двойно.
     */
    directMediaBytes: 2 * 1024 * 1024 * 1024,
  },
  social: {
