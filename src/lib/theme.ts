 ...
 *
 * Пълната палитра в `globals.css` е около трийсет променливи и повечето са
 * производни — сенки, състояния, вариации за админ панела. Тук са изведени
 * само тези, които наистина определят как изглежда сайтът. Останалите се
 * подреждат около тях.
 *
...
export const THEME_TOKENS: readonly ThemeTokenInfo[] = [
  ...
  {
    token: "--footer",
    setting: "theme_footer",
    label: "Фон на долната лента",
    hint: "Лентата с „Контакти“, „Информация“ и бюлетина най-долу",
    fallback: "#fffcf5",
  },
  {
    token: "--footer-foreground",
    setting: "theme_footer_foreground",
    label: "Текст в долната лента",
    hint: "Ако фонът ѝ е тъмен, тук трябва светъл цвят",
    fallback: "#342c25",
  },
] as const;
