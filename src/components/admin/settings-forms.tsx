    ...
    <form action={action}>
      <Card className="p-6 space-y-4">
        ...
        <Alert>
          ...
          законодателство, но местата в квадратни скоби{" "}
          <code className="font-mono text-xs">[Име на фирмата]</code>,{" "}
          <code className="font-mono text-xs">[ЕИК/БУЛСТАТ]</code> и{" "}
          <code className="font-mono text-xs">[Адрес на управление]</code> трябва
          да бъдат попълнени с реалните данни преди пускане на сайта.
          Препоръчваме окончателен преглед от юрист.
        </Alert>
